...
PREPARE_VARS = ["zsoil", "km", "count", "zsoil_root", "q0", "cmc", "th2", "rho", "qs1", "ice",
                "prcp", "dqsdt2", "snowh", "sneqv", "chx", "cmx", "z0",
...
EVAPO_VARS1 = ["ice", "sncovr", "etp", "nroot", "smcmax", "smcwlt", "smcref", "smcdry", "dt", "shdfac",
               "cmc", "sh2o", "flag_iter", "land", "sneqv", "count",
               "sgx", "gx", "edir1", "ec1", "edir", "ec"]  # output

EVAPO_VARS2 = ["ice", "sncovr", "shdfac", "etp", "flag_iter", "land", "sneqv", "count", "rtdis", "sgx",
               "denom", "gx"]  # output

EVAPO_VARS3 = ["ice", "sncovr", "edir", "ec", "shdfac", "etp", "flag_iter", "land", "sneqv", "count", "gx", "cmc", "pc",
               "denom", "edir1", "ec1",
               "et1", "ett1", "eta1", "et", "ett", "eta"]  # output

SMFLX_VARS1 = ["smcmax", "dt", "smcwlt", "prcp", "prcp1", "zsoil", "shdfac", "ec1",
...
SMFLX_VARS2 = ["ice", "smcmax", "etp", "dt", "bexp", "kdt", "frzx", "dksat", "dwsat", "slope",
...
SMFLX_VARS3 = ["ice", "dt", "smcmax", "flag_iter", "land", "sice", "zsoil", "rhsct", "ci", "sneqv",
               "sh2o", "smc", "cmc", "runoff3"]

SHFLX_VARS1 = ["ssoil", "land", "flag_iter", "sneqv", "etp", "eta", "smc", "quartz", "smcmax", "ivegsrc",
...
SHFLX_VARS2 = ["ice", "sneqv_new", "sncovr", "dt", "snowh", "sndens", 
               "land", "flag_iter", "sneqv", "zsoil", "stsoil", "p", "delta",
...
def run(in_dict, in_dict2, backend):
    ...
    evapo_first(**{k: general_dict[k] for k in EVAPO_VARS1})

    evapo_second(**{k: general_dict[k] for k in EVAPO_VARS2})

    evapo_third(**{k: general_dict[k] for k in EVAPO_VARS3})

    smflx_first(**{k: general_dict[k] for k in SMFLX_VARS1})

    smflx_second(**{k: general_dict[k] for k in SMFLX_VARS2})

    rosr12_second(general_dict["delta"], general_dict["p"],
                  general_dict["flag_iter"], general_dict["land"], general_dict["ci"])
    
    # print("ci: ", general_dict["ci"][145])

    smflx_third(**{k: general_dict[k] for k in SMFLX_VARS3})

    shflx_first(**{k: general_dict[k] for k in SHFLX_VARS1})

    shflx_second(**{k: general_dict[k] for k in SHFLX_VARS2})
