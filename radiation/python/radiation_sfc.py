...
class SurfaceClass:
    ...
    def setalb(
        ...
        if self.ialbflg == 0:  # use climatological albedo scheme
            ...
            #         sfcalb[i, 0, k][0] = min(0.99, ab2bm) * flnd + asenb * fsea + asnnb * fsno
            #         sfcalb[i, 0, k][1] = (a2 + b2) * 0.96 * flnd + asend * fsea + asnnd * fsno
            #         sfcalb[i, 0, k][2] = min(0.99, ab1bm) * flnd + asevb * fsea + asnvb * fsno
            #         sfcalb[i, 0, k][3] = (a1 + b1) * 0.96 * flnd + asevd * fsea + asnvd * fsno
        ...
        #             sfcalb[i, 0, k][0] = ab1bm * flnd + asenb * fsea + asnnb * fsno
        #             sfcalb[i, 0, k][1] = alnwf[i] * flnd + asend * fsea + asnnd * fsno
        #             sfcalb[i, 0, k][2] = ab2bm * flnd + asevb * fsea + asnvb * fsno
        #             sfcalb[i, 0, k][3] = alvwf[i] * flnd + asevd * fsea + asnvd * fsno
