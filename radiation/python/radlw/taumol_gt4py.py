...
from radlw.radlw_param import nrates, nspa, nspb, ng01, ng02, ng03, ns02, ns03, oneminus
...
outdict_val = dict()
for var in outvars:
    outdict_val[var] = serializer.read(var, serializer.savepoint['lwrad-taugb03-output-000000'])
