...
@stencil(backend=backend, rebuild=rebuild, externals={'nspa': nspa[7],
                                                      'nspb': nspb[7],
                                                      'laytrop': indict['laytrop'],
                                                      'ng08': ng08,
                                                      'ns08': ns08,
...
def taugb08(coldry: FIELD_FLT,
    ...
    with computation(PARALLEL), interval(0, laytrop):
        ...
        for ig in range(ng08):
            ...
            taug[0, 0, 0][ns08+ig] = colamt[0, 0, 0][0] * \
                (fac00*absa[0, 0, 0][ig, ind0] + fac10*absa[0, 0, 0][ig, ind0p] + \
                 fac01*absa[0, 0, 0][ig, ind1] + fac11*absa[0, 0, 0][ig, ind1p]) + \
                tauself+taufor + adjcolco2*absco2 + colamt[0, 0, 0][2]*abso3 + \
                colamt[0, 0, 0][3]*absn2o + wx[0, 0, 0][2]*cfc12[0, 0, 0][ig] + \
    ...
    with computation(PARALLEL), interval(laytrop, nlay):
        ...
        for ig2 in range(ng08):
            ...
            taug[0, 0, 0][ns08+ig2] = colamt[0, 0, 0][2] * \
                (fac00*absb[0, 0, 0][ig2, ind0] + fac10*absb[0, 0, 0][ig2, ind0p] + \
                 fac01*absb[0, 0, 0][ig2, ind1] + fac11*absb[0, 0, 0][ig2, ind1p]) + \
                adjcolco2*absco2 + colamt[0, 0, 0][3]*absn2o + wx[0, 0, 0][2] * \
                cfc12[0, 0, 0][ig2] + wx[0, 0, 0][3]*cfc22adj[0, 0, 0][ig2]
...
@stencil(backend=backend, rebuild=rebuild, externals={'nspa': nspa[9],
                                                      'nspb': nspb[9],
                                                      'laytrop': indict['laytrop'],
                                                      'ng10': ng10,
                                                      'ns10': ns10,
                                                      'nlay': nlay,
                                                      'oneminus': oneminus})
def taugb10(colamt: Field[type_maxgas],
            fac00: FIELD_FLT,
            fac01: FIELD_FLT,
            fac10: FIELD_FLT,
            fac11: FIELD_FLT,
    ...
    with computation(PARALLEL), interval(0, laytrop):
        ...
        for ig in range(ng10):
            ...
            taug[0, 0, 0][ns10+ig] = colamt[0, 0, 0][0] * \
                (fac00*absa[0, 0, 0][ig, ind0] + fac10*absa[0, 0, 0][ig, ind0p] + \
                 fac01*absa[0, 0, 0][ig, ind1] + fac11*absa[0, 0, 0][ig, ind1p]) + \
                tauself + taufor
    ...
    with computation(PARALLEL), interval(laytrop, nlay):
        ...
        for ig2 in range(ng10):
            ...
            taug[0, 0, 0][ns10+ig2] = colamt[0, 0, 0][0] * \
                (fac00*absb[0, 0, 0][ig2, ind0] + fac10*absb[0, 0, 0][ig2, ind0p] + \
                 fac01*absb[0, 0, 0][ig2, ind1] + fac11*absb[0, 0, 0][ig2, ind1p]) + \
                taufor
...
@stencil(backend=backend, rebuild=rebuild, externals={'nspa': nspa[11],
                                                      'nspb': nspb[11],
                                                      'laytrop': indict['laytrop'],
                                                      'ng12': ng12,
                                                      'ns12': ns12,
                                                      'nlay': nlay,
                                                      'oneminus': oneminus})
def taugb12(colamt: Field[type_maxgas],
            rfrate: Field[(np.float64, (nrates, 2))],
            fac00: FIELD_FLT,
            fac01: FIELD_FLT,
            fac10: FIELD_FLT,
...
@stencil(backend=backend, rebuild=rebuild, externals={'nspa': nspa[12],
                                                      'nspb': nspb[12],
                                                      'laytrop': indict['laytrop'],
                                                      'ng13': ng13,
                                                      'ns13': ns13,
...
def taugb13(coldry: FIELD_FLT,
    ...
    with computation(PARALLEL), interval(...):
        ...
        refrat_planck_a = chi_mls[0, 0, 0][0, 4]/chi_mls[0, 0, 0][3, 4]        # P = 473.420 mb (Level 5)
        refrat_m_a = chi_mls[0, 0, 0][0, 0]/chi_mls[0, 0, 0][3, 0]             # P = 1053. (Level 1)
        refrat_m_a3 = chi_mls[0, 0, 0][0, 2]/chi_mls[0, 0, 0][3, 2]            # P = 706. (Level 3)
        ...
        for ig in range(ng13):
            ...
            taug[0, 0, 0][ns13+ig] = speccomb * \
                ...
                (fac001*absa[0, 0, 0][ig, id001] + fac011*absa[0 ,0, 0][ig, id011] + \
                 fac101*absa[0, 0, 0][ig, id101] + fac111*absa[0, 0, 0][ig, id111] + \
                 fac201*absa[0, 0, 0][ig, id201] + fac211*absa[0, 0, 0][ig, id211]) + \
                tauself + taufor + adjcolco2*absco2 + colamt[0, 0, 0][6]*absco
...
@stencil(backend=backend, rebuild=rebuild, externals={'nspa': nspa[13],
                                                      'nspb': nspb[13],
                                                      'laytrop': indict['laytrop'],
                                                      'ng14': ng14,
                                                      'ns14': ns14,
                                                      'nlay': nlay,
                                                      'oneminus': oneminus})
def taugb14(colamt: Field[type_maxgas],
            fac00: FIELD_FLT,
            fac01: FIELD_FLT,
            fac10: FIELD_FLT,
            fac11: FIELD_FLT,
    ...
    with computation(PARALLEL), interval(0, laytrop):
        ...
        for ig in range(ng14):
            ...
            taug[0, 0, 0][ns14+ig] = colamt[0, 0, 0][1] * \
                (fac00*absa[0, 0, 0][ig, ind0] + fac10*absa[0, 0, 0][ig, ind0p] + \
                 fac01*absa[0, 0, 0][ig, ind1] + fac11*absa[0, 0, 0][ig, ind1p]) + \
                tauself + taufor
...
lookupdict_gt4py = loadlookupdata('kgb08')

start = time.time()
taugb08(indict_gt4py['coldry'],
        indict_gt4py['colamt'],
        indict_gt4py['wx'],
        indict_gt4py['fac00'],
        indict_gt4py['fac01'],
...
lookupdict_gt4py = loadlookupdata('kgb10')

start = time.time()
taugb10(indict_gt4py['colamt'],
        indict_gt4py['fac00'],
        indict_gt4py['fac01'],
        indict_gt4py['fac10'],
        indict_gt4py['fac11'],
...
lookupdict_gt4py = loadlookupdata('kgb12')

start = time.time()
taugb12(indict_gt4py['colamt'],
        indict_gt4py['rfrate'],
        indict_gt4py['fac00'],
        indict_gt4py['fac01'],
        indict_gt4py['fac10'],
...
lookupdict_gt4py = loadlookupdata('kgb13')

start = time.time()
taugb13(indict_gt4py['coldry'],
        indict_gt4py['colamt'],
        indict_gt4py['rfrate'],
        indict_gt4py['fac00'],
        indict_gt4py['fac01'],
        ...
        lookupdict_gt4py['fracrefa'],
        lookupdict_gt4py['fracrefb'],
        lookupdict_gt4py['ka_mco'],
        lookupdict_gt4py['ka_mco2'],
        lookupdict_gt4py['kb_mo3'],
        lookupdict_gt4py['chi_mls'],
        locdict_gt4py['ind0'],
        locdict_gt4py['ind1'],
        locdict_gt4py['inds'],
...
lookupdict_gt4py = loadlookupdata('kgb14')

start = time.time()
taugb14(indict_gt4py['colamt'],
        indict_gt4py['fac00'],
        indict_gt4py['fac01'],
        indict_gt4py['fac10'],
        indict_gt4py['fac11'],
