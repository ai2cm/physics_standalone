...
with open('co2historicaldata_2016.txt', 'r') as f:
    x = f.readline()
...
ds = xr.Dataset({'co2dat': (('I', 'J', 'month'), darr),
                 'co2g1': co2g1,
                 'co2g2': co2g2,
                 'cline': cline,
                 'iyr': iyr})
...
dout = '/Users/AndrewP/Documents/work/physics_standalone/radiation/python/radlw/co2historicaldata_2016.nc'
