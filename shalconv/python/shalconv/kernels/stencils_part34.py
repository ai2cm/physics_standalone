    ...
    *,
    ...
    with computation(PARALLEL), interval(...):
        ...
        if cnvflg == 1:
            ...
            umean = max(
                umean, val
            )  # Passing literals (e.g. 1.0) to functions might cause errors in conditional statements
            tauadv = gdx / umean
    ...
    with computation(FORWARD):
        ...
        with interval(0, 1):
            ...
            if cnvflg == 1 and k_idx <= kmax and k_idx <= ktcon:
                ...
                delebar = (
                    delebar + dellae * xmb * dp / g
                )  # Where does dp come from? Is it correct to use the last value at line 1559 of samfshalcnv.F?
