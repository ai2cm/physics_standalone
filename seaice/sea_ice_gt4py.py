...
def fpvs_fn(t):
    ...
    # over liquid
    pvl = PSAT * (tr ** FPVS_XPONAL) * exp(FPVS_XPONBL * (1.0 - tr))

    # over ice
    pvi = PSAT * (tr ** FPVS_XPONAI) * exp(FPVS_XPONBI * (1.0 - tr))
    ...
    *,
    ...
    with computation(PARALLEL), interval(...):
        ...
        if flag:
            ...
            qs1 = qs1 if qs1 > 1.0e-8 else 1.0e-8
